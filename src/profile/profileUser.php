        ...
        <div class="col-md-9 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                  ...
                  <div class="row mt-3">
                    <div class="col-md-3">
                      <a href="editInfo.php" class="simple-button" type="button">Edit Information</a>
                  </div>
                    <div class="col-md-3">
                      <a href="history.php" class="simple-button" type="button">View History</a>
                  </div>
                  <div class="col-md-3">
                    <a href="changePassword.php" class="simple-button" target="_blank" rel="noopener noreferrer" type="button">Change Password</a>
                </div>
                </div>
              </div>
            </div>
